...
exports.revealTile = exports.positionMatch = exports.markedTilesCount = exports.markTile = exports.createBoard = exports.checkWin = exports.checkLose = exports.TILE_STATUSES = void 0;
...
var positionMatch = function positionMatch(a, b) {
  return a.x === b.x && a.y === b.y;
};
exports.positionMatch = positionMatch;
var nearbyTiles = function nearbyTiles(board, _ref) {
  var x = _ref.x,
    y = _ref.y;
  var offsets = (0, _fp.range)(-1, 2);
  return offsets.flatMap(function (xOffset) {
    return offsets.flatMap(function (yOffset) {
      var _board;
...
var replaceTile = function replaceTile(board, position, newTile) {
...
var markedTilesCount = function markedTilesCount(board) {
...
var createBoard = function createBoard(boardSize, minePositions) {
  var board = [];
  ...
  return (0, _fp.times)(function (x) {
    return (0, _fp.times)(function (y) {
      return {
        x: x,
        y: y,
        mine: minePositions.some(function (p) {
...
var revealTile = function revealTile(board, _ref2) {
  var x = _ref2.x,
    y = _ref2.y;
  var tile = board[x][y];
  ...
  var mines = adjacentTiles.filter(function (tile) {
    return tile.mine;
  });
...
var markTile = function markTile(board, _ref3) {
  var x = _ref3.x,
    y = _ref3.y;
  var tile = board[x][y];
  if (tile.status !== TILE_STATUSES.HIDDEN && tile.status !== TILE_STATUSES.MARKED) return board;
  if (tile.status === TILE_STATUSES.MARKED) return replaceTile(board, {
    x: x,
    y: y
  }, _objectSpread(_objectSpread({}, tile), {}, {
    status: TILE_STATUSES.HIDDEN
  }));else return replaceTile(board, {
    x: x,
    y: y
  }, _objectSpread(_objectSpread({}, tile), {}, {
...
var checkLose = function checkLose(board) {
...
var listMinesLeft = function listMinesLeft() {
...
var checkGameEnd = function checkGameEnd() {
  ...
  if (win || lose) {
    boardElement.addEventListener("click", stopPropagation, {
      capture: true
    });
...
var tiletoElement = function tiletoElement(tile) {
...
var getTileElements = function getTileElements() {
...
function getMinePositions(boardSize, numberOfMines) {
  ...
  var _loop = function _loop() {
    ...
    if (!positions.some(function (p) {
      return (0, _minesweeper.positionMatch)(position, p);
    })) {
